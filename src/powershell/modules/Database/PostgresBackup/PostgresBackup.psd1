@{
    ...
    PrivateData       = @{
        PSData = @{
            ...
            ProjectUri   = ''
            ReleaseNotes = '2.1.0: pg_dump path is now auto-detected (PGBACKUP_PGDUMP / PGBIN env vars, PATH, then standard Windows install roots) instead of being hardcoded, improving portability across machines.'
        }
    }
}
