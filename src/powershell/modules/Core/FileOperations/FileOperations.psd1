@{
    ...
    PrivateData       = @{
        PSData = @{
            ...
            ReleaseNotes = '1.0.4: Use -LiteralPath in Test-FolderWritable for all filesystem checks so paths containing wildcard metacharacters ([, ], *, ?) are handled correctly.
1.0.3: Fixed private ErrorHandling dependency import path when loading from the Public/Private module layout.
