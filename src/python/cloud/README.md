...
# (run.log -> run_YYYYMMDD_HHMMSS.log); creates a NEW file per run rather than
# truncating the configured one
python gdrive_recover.py recover-and-download \
  --download-dir ./recovered \
